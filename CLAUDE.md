...
- **Mudou regra de apuração?** Muda a especificação primeiro, depois a migration **nova** (nunca editar migration já aplicada), depois o teste. `cd dev && npm test` precisa ficar verde (146 testes).
